...
def update_objects():
    ...
    global running, gravity, direction, friction
    columns, rows = shutil.get_terminal_size()
    ground_level = rows - 2  
    ...
    while running:
        for obj in objects:
            for obj2 in objects:
                if obj != obj2:  
                    if obj["x"] == obj2["x"] and obj["y"] == obj2["y"]:
                        # Collision detected; handle it here
                        # Example: exchange velocities
                        obj["velocity_x"], obj2["velocity_x"] = obj2["velocity_x"], obj["velocity_x"]
                        obj["velocity_y"], obj2["velocity_y"] = obj2["velocity_y"], obj["velocity_y"]
                                
            obj["velocity_y"] += gravity  # Increase downward velocity due to gravity
